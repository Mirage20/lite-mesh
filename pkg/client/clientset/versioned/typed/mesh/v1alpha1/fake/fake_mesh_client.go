...
import (
	v1alpha1 "github.com/mirage20/lite-mesh/pkg/client/clientset/versioned/typed/mesh/v1alpha1"
...
func (c *FakeMeshV1alpha1) Configurations(namespace string) v1alpha1.ConfigurationInterface {
