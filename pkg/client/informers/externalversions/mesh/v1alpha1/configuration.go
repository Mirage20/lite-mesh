...
import (
	...
	meshv1alpha1 "github.com/mirage20/lite-mesh/pkg/apis/mesh/v1alpha1"
	versioned "github.com/mirage20/lite-mesh/pkg/client/clientset/versioned"
	internalinterfaces "github.com/mirage20/lite-mesh/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/mirage20/lite-mesh/pkg/client/listers/mesh/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MeshV1alpha1().Configurations(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MeshV1alpha1().Configurations(namespace).Watch(options)
			},
		},
		&meshv1alpha1.Configuration{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *configurationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&meshv1alpha1.Configuration{}, f.defaultInformer)
}
